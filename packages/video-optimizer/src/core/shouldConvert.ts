import type { ConversionDecision, ResolvedVideoOptimizerConfig, UploadedFile } from '../types.js'
...
export const shouldConvert = (
  ...
  config: Pick<ResolvedVideoOptimizerConfig, 'inputMimeTypes' | 'maxInputFileSize'>,
): ConversionDecision => {
