...
import { registerUnregisteredCollectionScenarios } from './unregisteredScenarios.js'
...
runCopyScenarios(
  {
    ...
    copy: async (source, target, { copyConfig }) => {
      ...
      const backupData = await backup(source.db.connection, {
        ...
        unregisteredCollections: resolved.unregistered,
  ...
  {
    extras: registerUnregisteredCollectionScenarios,
  },
)
