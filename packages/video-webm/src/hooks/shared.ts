 ...
 * fire at all.
 */
export const QUEUE_CONTEXT_KEY = 'videoWebmQueuePending'
 ...
 * down with it just because its snapshot of `webmVersions` is older.
 */
export const GC_CONTEXT_KEY = 'videoWebmAllowGc'
