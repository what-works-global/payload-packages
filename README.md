...
| [`@whatworks/payload-heading-field`](./packages/heading-field)             | Let editors choose the rendered heading tag (`h1`–`h6`) for a text, textarea, or richText field. |
...
| [`@whatworks/payload-sitemap`](./packages/sitemap)                         | Chunked, lazily cached XML sitemaps with hook-driven invalidation and robots.txt helpers.        |
| [`@whatworks/payload-switch-env`](./packages/switch-env)                   | Switch a running admin between production and development databases, or copy prod-to-dev.        |
