...
| [`video-optimizer`](./packages/video-optimizer)         | Optimise video uploads into a WebM (VP9/Opus) size ladder via background jobs — the source stays stored, linked sidecars carry the renditions. |
